...
[Version 3.1.0] - Added support for one-line installation with remote execution compatible with $Force session variable. Added UpdateSelf command to automatically update the script to the latest version. Created short URL asheroto.com/winget.
