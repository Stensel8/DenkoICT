function Test-Winget {
    ...
    if ($winget) {
        ...
        try {
            ...
            Write-Warning "Winget was not found due to unavailability reasons"
            $wingetExists = $false
        } catch {
            Write-Warning "Winget was not found due to unknown reasons, The Stack Trace is:`n$($psitem.Exception.StackTrace)"
            $wingetExists = $false
        }
